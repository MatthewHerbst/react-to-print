...
export default class ReactToPrint extends React.Component<IReactToPrintProps> {
  ...
  public render() {
    const { trigger, onBeforeGetContent } = this.props;
    const onBeforeGetContentPromise = onBeforeGetContent();
    return React.cloneElement(trigger(), {
      onClick: () =>
        onBeforeGetContentPromise && typeof onBeforeGetContentPromise.then === "function"
          ? onBeforeGetContentPromise.then(() => this.handlePrint())
          : this.handlePrint(),
      ref: this.setRef
    });
  }
