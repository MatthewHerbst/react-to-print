...
- CHORE [TBD](https://github.com/MatthewHerbst/react-to-print/pull/TBD): Add a test suite — Vitest + jsdom unit/integration tests for the utilities and hook, Playwright real-browser smoke tests for the print flow, and a GitHub Actions CI workflow running lint, build, and tests
