...
| **`printDelay`** | `number` | The delay, in milliseconds, between the print content being ready and the print dialog being triggered. Some browsers, notably Safari, do not behave well without a short delay here. Defaults to `500` |
